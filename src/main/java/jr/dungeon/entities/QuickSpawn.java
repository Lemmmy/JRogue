...
public class QuickSpawn {
	...
	public static <EntityT extends Entity> EntityT spawnClass(Class<EntityT> entityClass, Level level, int x, int y) {
		try {
			...
			EntityT entity = (EntityT) entityConstructor.newInstance(
