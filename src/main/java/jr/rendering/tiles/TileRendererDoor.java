...
public class TileRendererDoor extends TileRenderer {
	...
	public void onLoad(Assets assets) {
		super.onLoad(assets);
		assets.textures.load(textureName("room_door_open_horizontal"), t -> openH = new TextureRegion(t));
		assets.textures.load(textureName("room_door_open_vertical"), t -> openV = new TextureRegion(t));
	}
