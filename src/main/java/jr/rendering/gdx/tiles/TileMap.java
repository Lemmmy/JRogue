...
public enum TileMap {
	...
	TILE__FLOOR(new TileRenderer_Floor(8, 0, ReflectionSettings.create(0.0f, 0.0f, 0.0f, 3.0f, -0.2f), false, TileType.TILE__FLOOR)),
	TILE__BRIDGE(new TileRenderer_Bridge(8, 2));
