...
public abstract class TileRendererBlob4 extends TileRenderer {
	...
	public TileRendererBlob4() {
		this(0, 0);
	}
	
	public TileRendererBlob4(int blobOffsetX, int blobOffsetY) {
